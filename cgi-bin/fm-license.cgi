...
#my $create_signature = "/usr/local/www/servers/sal.csl.sri.com/cgi-bin/create_signature";
#my $csparams = "/homes/webserver/etc/csparams";

my $create_signature = "/web/sal.csl.sri.com/cgi-bin/create_signature";
my $csparams = "/web/sal.csl.sri.com/csparams";
